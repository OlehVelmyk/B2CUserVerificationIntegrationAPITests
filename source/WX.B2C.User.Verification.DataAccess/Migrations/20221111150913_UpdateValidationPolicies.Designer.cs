...
namespace WX.B2C.User.Verification.DataAccess.Migrations
{
    ...
    [Migration("20221111150913_UpdateValidationPolicies")]
    partial class UpdateValidationPolicies
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WX.B2C.User.Verification.DataAccess.Entities.Note", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("WX.B2C.User.Verification.DataAccess.Entities.Policy.MonitoringPolicy", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            Id = new Guid("fff1401f-6888-4c05-ba23-4843e8e88ec9"),
                            Name = "USA monitoring policy",
                            Region = "US",
                            RegionType = 3
                        });
                });
            ...
            modelBuilder.Entity("WX.B2C.User.Verification.DataAccess.Entities.Policy.PolicyCheckVariant", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            ...
                            Config = "{\"searchNames\":[\"Political Exposure\",\"Reputational Risk\",\"Sanctions Screening\"]}",
                        ...
                        new
                        {
                            Id = new Guid("3d410715-dfc6-4952-82ca-9fd1ad53cba5"),
                            Config = "{\"searchNames\":[\"PEP Family Members\"]}",
                            Name = "US Pep Family Members",
                            Provider = "LexisNexis",
                            Type = "RiskListsScreening"
                        },
                        new
                        {
                            ...
                            Config = "{\"reportName\":\"facial_similarity_photo\",\"isSelfieOptional\":true,\"isVideoRequired\":false}",
                        ...
                        new
                        {
                            ...
                            Config = "{\"reportName\":\"facial_similarity_video\",\"isSelfieOptional\":true,\"isVideoRequired\":true}",
            ...
            modelBuilder.Entity("WX.B2C.User.Verification.DataAccess.Entities.Policy.TriggerVariant", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            ...
                            Conditions = "[{\"Type\":5,\"Value\":{\"riskLevel\":\"Low\",\"threshold\":75000,\"step\":75000}},{\"Type\":5,\"Value\":{\"riskLevel\":\"Medium\",\"threshold\":60000,\"step\":60000}},{\"Type\":5,\"Value\":{\"riskLevel\":\"High\",\"threshold\":15000,\"step\":30000}},{\"Type\":5,\"Value\":{\"riskLevel\":\"ExtraHigh\",\"threshold\":15000,\"step\":30000}}]",
                            Iterative = true,
                        ...
                        new
                        {
                            Id = new Guid("50283357-6227-4793-b104-5331c80f86e2"),
                            Commands = "[{\"Type\":3,\"Config\":\"{\\\"taskType\\\":\\\"RiskListsScreening\\\",\\\"variantId\\\":\\\"3D410715-DFC6-4952-82CA-9FD1AD53CBA5\\\",\\\"force\\\":false}\"}]",
                            Conditions = "[{\"Type\":4,\"Value\":{\"riskLevel\":\"ExtraHigh\",\"threshold\":400}},{\"Type\":4,\"Value\":{\"riskLevel\":\"High\",\"threshold\":400}},{\"Type\":4,\"Value\":{\"riskLevel\":\"Medium\",\"threshold\":400}},{\"Type\":4,\"Value\":{\"riskLevel\":\"Low\",\"threshold\":400}}]",
                            Iterative = false,
                            Name = "PEP Family Members",
                            PolicyId = new Guid("fff1401f-6888-4c05-ba23-4843e8e88ec9")
                        });
                });
            ...
            modelBuilder.Entity("WX.B2C.User.Verification.DataAccess.Entities.Reminder", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("WX.B2C.User.Verification.DataAccess.Entities.DocumentFile", b =>
                {
                    b.HasOne("WX.B2C.User.Verification.DataAccess.Entities.Document", "Document")
                        .WithMany("Files")
