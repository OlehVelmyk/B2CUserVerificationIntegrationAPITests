...
namespace WX.B2C.User.Verification.Api.Webhook.Client
{
    ...
    /// <summary>
    /// Extension methods for HealthCheck.
    /// </summary>
    public static partial class HealthCheckExtensions
    {
            ...
            /// </param>
            public static async Task PostAsync(this IHealthCheck operations, CancellationToken cancellationToken = default(CancellationToken))
            {
