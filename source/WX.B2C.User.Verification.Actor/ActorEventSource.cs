...
{
    [EventSource(Name = "WX.B2C.User.Verification.Actor")]
...
#region Events
        ...
        public void ActorMessage(Microsoft.ServiceFabric.Actors.Runtime.Actor actor, string message, params object[] args)
        {
            ...
            {
                var finalMessage = string.Format(message, args);
                ActorMessage(actor.GetType().ToString(),
                             actor.Id.ToString(),
        ...
        private
            ...
            unsafe
#endif
            void ActorMessage(string actorType,
                              string actorId,
        ...
        {
#if !UNSAFE
            WriteEvent(ActorMessageEventId,
                       actorType,
                       actorId,
                       applicationTypeName,
                       applicationName,
                ...
                fixed (char* pActorType = actorType, pActorId = actorId, pApplicationTypeName = applicationTypeName, pApplicationName =
 applicationName, pServiceTypeName = serviceTypeName, pServiceName = serviceName, pNodeName = nodeName, pMessage = message)
                {
