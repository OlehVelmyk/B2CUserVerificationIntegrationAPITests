...
namespace WX.B2C.User.Verification.PassFort.Client.Models
{
    ...
    /// </remarks>
    [Newtonsoft.Json.JsonObject("REFER_FLAG")]
    public partial class EventDataReferFlag : EventData
    {
        /// <summary>
        /// Initializes a new instance of the EventDataReferFlag class.
        /// </summary>
        public EventDataReferFlag()
        {
            CustomInit();
        }
        ...
        public EventDataReferFlag(string matchId = default(string), string gender = default(string), IList<string> deceasedDates = default(IList<string>), bool? deceased = default(bool?), string modifiedDate = default(string), string providerName = default(string), string matchName = default(string), string brandText = default(string), string matchCustomLabel = default(string), IList<string> matchDates = default(IList<string>), IList<DateMatchData> matchDatesData = default(IList<DateMatchData>), IList<string> matchCountries = default(IList<string>), IList<string> matchCountriesAddress = default(IList<string>), IList<CountryMatchData> matchCountriesData = default(IList<CountryMatchData>), double? score = default(double?), IList<string> aliases = default(IList<string>), IList<string> previousNames = default(IList<string>), IList<Associate> associates = default(IList<Associate>), string profileNotes = default(string), IList<MatchDetail> details = default(IList<MatchDetail>), IList<Document> documents = default(IList<Document>), string riskography = default(string), IList<Source> sources = default(IList<Source>), IList<string> remarks = default(IList<string>), IList<Identification> identifications = default(IList<Identification>), IList<Location> locations = default(IList<Location>))
        {
            MatchId = matchId;
            Gender = gender;
