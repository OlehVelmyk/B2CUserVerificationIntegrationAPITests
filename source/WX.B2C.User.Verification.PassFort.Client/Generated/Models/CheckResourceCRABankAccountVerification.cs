...
namespace WX.B2C.User.Verification.PassFort.Client.Models
{
    ...
    /// Reference](/reference/checks/individuals/bank-account-verification)
    /// </remarks>
    [Newtonsoft.Json.JsonObject("CheckResourceCRABankAccountVerification")]
    public partial class CheckResourceCRABankAccountVerification : CheckResource
    {
        /// <summary>
        /// Initializes a new instance of the
        /// CheckResourceCRABankAccountVerification class.
        /// </summary>
        public CheckResourceCRABankAccountVerification()
        {
            CustomInit();
        }
        ...
        /// '1+1'</param>
        public CheckResourceCRABankAccountVerification(string id = default(string), CheckVariant variant = default(CheckVariant), CheckState? state = default(CheckState?), string performedOn = default(string), IList<Error> errors = default(IList<Error>), IList<string> taskIds = default(IList<string>), bool? instructedExternally = default(bool?), DecisionClass? decision = default(DecisionClass?), IList<CheckResourceProvidersItem> providers = default(IList<CheckResourceProvidersItem>), IndividualData inputData = default(IndividualData), CheckResourceCRABankAccountVerificationOutputData outputData = default(CheckResourceCRABankAccountVerificationOutputData), CheckResult? result = default(CheckResult?))
        ...
        public CheckResourceCRABankAccountVerificationOutputData OutputData { get; set; }
