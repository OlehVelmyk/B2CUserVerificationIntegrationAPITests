...
namespace WX.B2C.User.Verification.PassFort.Client.Models
{
    ...
    /// Reference](/reference/checks/individuals/document-verification)
    /// </remarks>
    [Newtonsoft.Json.JsonObject("DOCUMENT_VERIFICATION")]
    public partial class CheckResourceDocumentVerification : CheckResource
    {
        /// <summary>
        /// Initializes a new instance of the CheckResourceDocumentVerification
        /// class.
        /// </summary>
        public CheckResourceDocumentVerification()
        {
            CustomInit();
        }
        ...
        /// '1+1'</param>
        public CheckResourceDocumentVerification(string documentId, string id = default(string), CheckVariant variant = default(CheckVariant), CheckState? state = default(CheckState?), string performedOn = default(string), IList<Error> errors = default(IList<Error>), IList<string> taskIds = default(IList<string>), bool? instructedExternally = default(bool?), DecisionClass? decision = default(DecisionClass?), IList<CheckResourceProvidersItem> providers = default(IList<CheckResourceProvidersItem>), IndividualData inputData = default(IndividualData), CheckResourceDocumentVerificationOutputData outputData = default(CheckResourceDocumentVerificationOutputData), CheckResult? result = default(CheckResult?))
        ...
        public CheckResourceDocumentVerificationOutputData OutputData { get; set; }
