...
namespace WX.B2C.User.Verification.PassFort.Client.Models
{
    ...
    /// </remarks>
    [Newtonsoft.Json.JsonObject("SANCTION_FLAG")]
    public partial class EventDataSanctionFlag : EventData
    {
        /// <summary>
        /// Initializes a new instance of the EventDataSanctionFlag class.
        /// </summary>
        public EventDataSanctionFlag()
        {
            CustomInit();
        }
        ...
        /// <param name="providerName">Data provider source</param>
        ...
        /// <param name="matchDates">Dates of the matched result</param>
        ...
        /// <param name="documents">Documents related to the sanctions
        /// match</param>
        /// <param name="riskography">Description of sanctioned persons
        /// background</param>
        /// <param name="locations">Locations related to a sanctioned person,
        /// such as a place of birth</param>
        ...
        public EventDataSanctionFlag(string matchId = default(string), string modifiedDate = default(string), string providerName = default(string), string matchName = default(string), string brandText = default(string), string matchCustomLabel = default(string), IList<string> matchDates = default(IList<string>), IList<DateMatchData> matchDatesData = default(IList<DateMatchData>), IList<string> matchCountries = default(IList<string>), IList<string> matchCountriesAddress = default(IList<string>), IList<CountryMatchData> matchCountriesData = default(IList<CountryMatchData>), double? score = default(double?), IList<string> aliases = default(IList<string>), IList<string> previousNames = default(IList<string>), IList<Associate> associates = default(IList<Associate>), string profileNotes = default(string), IList<MatchDetail> details = default(IList<MatchDetail>), IList<Sanction> sanctions = default(IList<Sanction>), IList<Document> documents = default(IList<Document>), string riskography = default(string), IList<Location> locations = default(IList<Location>), IList<Identification> identifications = default(IList<Identification>), IList<string> remarks = default(IList<string>), IList<Source> sources = default(IList<Source>), string gender = default(string), IList<string> deceasedDates = default(IList<string>), bool? deceased = default(bool?))
        {
            MatchId = matchId;
        ...
        /// <summary>
        /// Gets or sets data provider source
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets dates of the matched result
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets documents related to the sanctions match
        /// </summary>
        [JsonProperty(PropertyName = "documents")]
        public IList<Document> Documents { get; set; }

        /// <summary>
        /// Gets or sets description of sanctioned persons background
        /// </summary>
        [JsonProperty(PropertyName = "riskography")]
        public string Riskography { get; set; }

        /// <summary>
        /// Gets or sets locations related to a sanctioned person, such as a
        /// place of birth
        /// </summary>
