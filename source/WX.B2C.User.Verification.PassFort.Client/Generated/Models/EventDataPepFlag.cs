...
namespace WX.B2C.User.Verification.PassFort.Client.Models
{
    ...
    /// </remarks>
    [Newtonsoft.Json.JsonObject("PEP_FLAG")]
    public partial class EventDataPepFlag : EventData
    {
        /// <summary>
        /// Initializes a new instance of the EventDataPepFlag class.
        /// </summary>
        public EventDataPepFlag()
        {
            CustomInit();
        }
        ...
        /// background</param>
        /// <param name="locations">Locations related to a PEP, such as a place
        /// of birth</param>
        /// <param name="identifications">Identifications such as a
        /// passport</param>
        /// <param name="remarks">Remarks about a PEP</param>
        ...
        public EventDataPepFlag(string matchId = default(string), string modifiedDate = default(string), string providerName = default(string), string matchName = default(string), string brandText = default(string), string matchCustomLabel = default(string), IList<string> matchDates = default(IList<string>), IList<DateMatchData> matchDatesData = default(IList<DateMatchData>), IList<string> matchCountries = default(IList<string>), IList<string> matchCountriesAddress = default(IList<string>), IList<CountryMatchData> matchCountriesData = default(IList<CountryMatchData>), double? score = default(double?), IList<string> aliases = default(IList<string>), IList<string> previousNames = default(IList<string>), IList<Associate> associates = default(IList<Associate>), string profileNotes = default(string), IList<MatchDetail> details = default(IList<MatchDetail>), PEP pep = default(PEP), string riskography = default(string), IList<Location> locations = default(IList<Location>), IList<Identification> identifications = default(IList<Identification>), IList<string> remarks = default(IList<string>), string pepRating = default(string), IList<Source> sources = default(IList<Source>), string gender = default(string), IList<string> deceasedDates = default(IList<string>), bool? deceased = default(bool?), IList<Document> documents = default(IList<Document>))
        {
            MatchId = matchId;
        ...
        /// <summary>
        /// Gets or sets locations related to a PEP, such as a place of birth
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets remarks about a PEP
        /// </summary>
