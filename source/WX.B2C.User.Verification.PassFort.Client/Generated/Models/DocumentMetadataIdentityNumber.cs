...
namespace WX.B2C.User.Verification.PassFort.Client.Models
{
    ...
    /// An identity number
    /// </remarks>
    public partial class DocumentMetadataIdentityNumber
    {
        /// <summary>
        /// Initializes a new instance of the DocumentMetadataIdentityNumber
        /// class.
        /// </summary>
        public DocumentMetadataIdentityNumber()
        {
            CustomInit();
        }
        ...
        /// <param name="number">The identifying number. Note that PassFort
        /// does not validate the number format.</param>
        ...
        public DocumentMetadataIdentityNumber(string documentType, string number, string countryCode, string issuingState = default(string), string version = default(string))
        {
        ...
        /// <summary>
        /// Gets or sets the identifying number. Note that PassFort does not
