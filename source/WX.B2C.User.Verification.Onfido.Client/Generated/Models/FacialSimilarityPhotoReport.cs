...
namespace WX.B2C.User.Verification.Onfido.Client.Models
{
    ...
    [Newtonsoft.Json.JsonObject("facial_similarity_photo")]
    public partial class FacialSimilarityPhotoReport : Report
    {
        /// <summary>
        /// Initializes a new instance of the FacialSimilarityPhotoReport
        /// class.
        /// </summary>
        ...
        public FacialSimilarityPhotoReport(string id, System.DateTime? createdAt = default(System.DateTime?), string href = default(string), string status = default(string), ReportResult? result = default(ReportResult?), ReportSubResult? subResult = default(ReportSubResult?), string checkId = default(string), IList<DocumentItem> documents = default(IList<DocumentItem>), FacialSimilarityPhotoReportBreakdown breakdown = default(FacialSimilarityPhotoReportBreakdown))
        ...
        public FacialSimilarityPhotoReportBreakdown Breakdown { get; set; }
