...
namespace WX.B2C.User.Verification.Onfido.Client.Models
{
    ...
    public partial class DocumentReport : Report
    {
        /// <summary>
        /// Initializes a new instance of the DocumentReport class.
        /// </summary>
        ...
        public DocumentReport(string id, System.DateTime? createdAt = default(System.DateTime?), string href = default(string), string status = default(string), ReportResult? result = default(ReportResult?), ReportSubResult? subResult = default(ReportSubResult?), string checkId = default(string), IList<DocumentItem> documents = default(IList<DocumentItem>), DocumentReportBreakdown breakdown = default(DocumentReportBreakdown), DocumentReportProperties properties = default(DocumentReportProperties))
        ...
        public DocumentReportBreakdown Breakdown { get; set; }

        /// <summary>
        /// </summary>
        [JsonProperty(PropertyName = "properties")]
        public DocumentReportProperties Properties { get; set; }
