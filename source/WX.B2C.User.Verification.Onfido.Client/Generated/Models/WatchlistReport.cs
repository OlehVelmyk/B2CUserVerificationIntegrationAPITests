...
namespace WX.B2C.User.Verification.Onfido.Client.Models
{
    ...
    [Newtonsoft.Json.JsonObject("watchlist_standard")]
    public partial class WatchlistReport : Report
    {
        /// <summary>
        /// Initializes a new instance of the WatchlistReport class.
        /// </summary>
        ...
        public WatchlistReport(string id, System.DateTime? createdAt = default(System.DateTime?), string href = default(string), string status = default(string), ReportResult? result = default(ReportResult?), ReportSubResult? subResult = default(ReportSubResult?), string checkId = default(string), IList<DocumentItem> documents = default(IList<DocumentItem>), WatchlistReportBreakdown breakdown = default(WatchlistReportBreakdown), WatchlistReportProperties properties = default(WatchlistReportProperties))
        ...
        public WatchlistReportBreakdown Breakdown { get; set; }

        /// <summary>
        /// </summary>
        [JsonProperty(PropertyName = "properties")]
        public WatchlistReportProperties Properties { get; set; }
