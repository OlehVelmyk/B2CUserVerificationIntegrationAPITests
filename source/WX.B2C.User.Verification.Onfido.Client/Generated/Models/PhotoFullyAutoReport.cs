...
namespace WX.B2C.User.Verification.Onfido.Client.Models
{
    ...
    [Newtonsoft.Json.JsonObject("photo_fully_auto")]
    public partial class PhotoFullyAutoReport : Report
    {
        /// <summary>
        /// Initializes a new instance of the PhotoFullyAutoReport class.
        /// </summary>
        public PhotoFullyAutoReport()
        {
            CustomInit();
        }
        ...
        public PhotoFullyAutoReport(string id, System.DateTime? createdAt = default(System.DateTime?), string href = default(string), string status = default(string), ReportResult? result = default(ReportResult?), ReportSubResult? subResult = default(ReportSubResult?), string checkId = default(string), IList<DocumentItem> documents = default(IList<DocumentItem>), PhotoFullyAutoReportBreakdown breakdown = default(PhotoFullyAutoReportBreakdown))
        ...
        public PhotoFullyAutoReportBreakdown Breakdown { get; set; }
