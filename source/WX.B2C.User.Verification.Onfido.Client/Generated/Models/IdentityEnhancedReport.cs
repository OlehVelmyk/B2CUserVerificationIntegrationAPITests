...
namespace WX.B2C.User.Verification.Onfido.Client.Models
{
    ...
    [Newtonsoft.Json.JsonObject("identity_enhanced")]
    public partial class IdentityEnhancedReport : Report
    {
        /// <summary>
        /// Initializes a new instance of the IdentityEnhancedReport class.
        /// </summary>
        ...
        public IdentityEnhancedReport(string id, System.DateTime? createdAt = default(System.DateTime?), string href = default(string), string status = default(string), ReportResult? result = default(ReportResult?), ReportSubResult? subResult = default(ReportSubResult?), string checkId = default(string), IList<DocumentItem> documents = default(IList<DocumentItem>), IdentityEnhancedReportBreakdown breakdown = default(IdentityEnhancedReportBreakdown), IdentityEnhancedReportProperties properties = default(IdentityEnhancedReportProperties))
        ...
        public IdentityEnhancedReportBreakdown Breakdown { get; set; }

        /// <summary>
        /// </summary>
        [JsonProperty(PropertyName = "properties")]
        public IdentityEnhancedReportProperties Properties { get; set; }
