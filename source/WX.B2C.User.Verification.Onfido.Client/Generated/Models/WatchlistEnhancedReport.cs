...
namespace WX.B2C.User.Verification.Onfido.Client.Models
{
    ...
    [Newtonsoft.Json.JsonObject("watchlist_enhanced")]
    public partial class WatchlistEnhancedReport : Report
    {
        /// <summary>
        /// Initializes a new instance of the WatchlistEnhancedReport class.
        /// </summary>
        ...
        public WatchlistEnhancedReport(string id, System.DateTime? createdAt = default(System.DateTime?), string href = default(string), string status = default(string), ReportResult? result = default(ReportResult?), ReportSubResult? subResult = default(ReportSubResult?), string checkId = default(string), IList<DocumentItem> documents = default(IList<DocumentItem>), WatchlistEnhancedReportBreakdown breakdown = default(WatchlistEnhancedReportBreakdown), WatchlistEnhancedReportProperties properties = default(WatchlistEnhancedReportProperties))
        ...
        public WatchlistEnhancedReportBreakdown Breakdown { get; set; }

        /// <summary>
        /// </summary>
        [JsonProperty(PropertyName = "properties")]
        public WatchlistEnhancedReportProperties Properties { get; set; }
