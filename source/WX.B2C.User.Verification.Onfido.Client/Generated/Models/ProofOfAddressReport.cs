...
namespace WX.B2C.User.Verification.Onfido.Client.Models
{
    ...
    [Newtonsoft.Json.JsonObject("proof_of_address")]
    public partial class ProofOfAddressReport : Report
    {
        /// <summary>
        /// Initializes a new instance of the ProofOfAddressReport class.
        /// </summary>
        ...
        public ProofOfAddressReport(string id, System.DateTime? createdAt = default(System.DateTime?), string href = default(string), string status = default(string), ReportResult? result = default(ReportResult?), ReportSubResult? subResult = default(ReportSubResult?), string checkId = default(string), IList<DocumentItem> documents = default(IList<DocumentItem>), ProofOfAddressReportBreakdown breakdown = default(ProofOfAddressReportBreakdown), ProofOfAddressReportProperties properties = default(ProofOfAddressReportProperties))
        ...
        public ProofOfAddressReportBreakdown Breakdown { get; set; }

        /// <summary>
        /// </summary>
        [JsonProperty(PropertyName = "properties")]
        public ProofOfAddressReportProperties Properties { get; set; }
