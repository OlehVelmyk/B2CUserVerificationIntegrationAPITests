...
{
    public class CollectionStepReviewRequested : DomainEvent
    {
        ...
        public static CollectionStepReviewRequested Create(CollectionStep collectionStep, Initiation initiation) =>
            new()
            {
