namespace WX.B2C.User.Verification.Api.Public.Client
{
    ...
    {
        public async Task<HttpOperationResponse<UploadedFileDto>> UploadWithHttpMessagesAsync(DocumentCategory documentCategory, string documentType, FileToUpload file, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (file == null)
            ...
            var _url = new System.Uri(new System.Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "api/v1/verification/documents/files").ToString();
            ...
            {
                { new StringContent(documentCategory.ToString()), "document_category" },
                { new StringContent(documentType.ToString()), "document_type" }
            };
            ...
            // TODO WRXB-9401 Set Credentials
