...
namespace WX.B2C.User.Verification.Api.Admin.Client.Models
{
    ...
    public partial class TaskCollectionStepDto
    {
        /// <summary>
        /// Initializes a new instance of the TaskCollectionStepDto class.
        /// </summary>
        public TaskCollectionStepDto()
        {
            CustomInit();
        }
        ...
        /// 'Rejected'</param>
        public TaskCollectionStepDto(System.Guid id, CollectionStepVariantDto variant, CollectionStepState state, object data, bool isRequired, bool isReviewNeeded, System.DateTime requestedAt, CollectionStepReviewResult? reviewResult = default(CollectionStepReviewResult?), string formattedData = default(string), System.DateTime? updatedAt = default(System.DateTime?))
        {
            Id = id;
            Variant = variant;
            State = state;
        ...
        /// <summary>
        /// </summary>
        [JsonProperty(PropertyName = "formattedData")]
