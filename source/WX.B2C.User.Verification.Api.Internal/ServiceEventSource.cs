...
{
    [EventSource(Name = "MyCompany-WX.B2C.User.Verification-WX.B2C.User.Verification.Api.Internal")]
          ...
          IEventSource
    {
        ...
        public void ServiceMessage(ServiceContext serviceContext, string message, params object[] args)
        {
            ...
            {
                var finalMessage = string.Format(message, args);
                ServiceMessage(serviceContext.ServiceName.ToString(),
        ...
        unsafe
#endif
            void ServiceMessage(string serviceName,
